...
<?php wp_head(); ?>
	...
	<body <?php body_class(); ?>>
<nav id="global-bar"><div class="left"><a href="https://mach-politik.ch">Hauptseite</a><a href="https://mach-politik.ch/projekte/projects/projekte">Projekte</a></div><div class="right"><a href="https://mach-politik.ch/projekte/login">Login</a><a href="https://mach-politik.ch/projekte/account/register">Registrieren</a></div></nav>
<div id="page" class="hfeed site">
	<header id="masthead" class="site-header" role="banner">
		...
		<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
			<img alt="Logo Mach-Politik.ch" width="960" height="250" src="../images/logo-B-2farbig-halbkreis-header-web.svg"
		</a>
